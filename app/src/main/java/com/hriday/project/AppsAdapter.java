...
//An adapter class which helps to represent the data in the given ArrayList of apps using the template layout item_app
public class AppsAdapter extends ArrayAdapter<com.hriday.project.App> {
    public AppsAdapter(Context context, ArrayList<com.hriday.project.App> usageStatDTOArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.hriday.project.App usageStats = getItem(position);
